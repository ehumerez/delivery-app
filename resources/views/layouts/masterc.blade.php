          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="#">
                ...
                <span>Tu Delivery</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="{{ url('deliveryc/pedido')}}"><i class="fa   fa-circle-o"></i>Relizar un Pedido</a></li>
                <li><a href="{{ url('deliveryc/cliente')}}"><i class="fa   fa-circle-o"></i>Mi cuenta</a></li>                
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{{ url('productosc/producto')}}"><i class="fa   fa-circle-o"></i> Lista de Productos</a></li>                
              </ul>
            </li>          
