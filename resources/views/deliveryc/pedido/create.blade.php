...
@section ('contenido')
	<div class="row">
		...
		{!! Form::open(array('url'=>'deliveryc/pedido','method'=>'POST','autocomplete'=>'off','files'=>'true'))!!}
			{{Form::token()}}
	...
	<div class="row">
		...
		<div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
			<div class="form-group">
				...
				<p id="costo_envio2"></p>
				<input type="hidden" name="costo_envio" id="costo_envio" required value="{{old('costo_envio')}}" class="form-control" placeholder="Costo envío.. Bs 00.00.-">
			</div>
		</div>
		<div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
			<div class="form-group">
				...
				<p id="monto2"></p>
				<input type="hidden" name="monto" id="monto" required value="{{old('monto')}}" class="form-control" placeholder="Total costo pedido.. Bs 00.00.-">
			</div>
		</div>
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			<div class="form-group">
				<label for="tiempo_entrega">Total tiempo entrega (Minutos)</label>
				<p id="tiempo_entrega2"></p>
				<input type="hidden" name="tiempo_entrega" id="tiempo_entrega" required value="{{old('tiempo_entrega')}}" class="form-control" placeholder="Total tiempo entrega..">
...
/////////////////////////////////////////////////////////////////////////////
	...
	function agregar(){
		...
		if (idproducto!="" && cantidad!="" && cantidad>0 && tiempo_prep!="" && precio!="") {
			...
			$("#monto2").html(total_precio+parseInt(costo_envio));
			...
			$("#tiempo_entrega2").html(total_tiempo+parseInt(tiempo_pedido));
