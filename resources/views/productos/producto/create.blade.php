...
@section ('contenido')
	<div class="row">
		...
		{!! Form::open(array('url'=>'productos/producto','method'=>'POST','autocomplete'=>'off','files'=>'true'))!!}
			{{Form::token()}}
	...
	<div class="row">
		...
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			<div class="form-group">
				...
				<select name="idcategoria_producto" id="idcategoria_producto" class="form-control selectpicker" data-live-search="true">
		...
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			<div class="form-group">
				...
				<input type="text" name="precio" id="precio" required value="{{old('precio')}}" class="form-control" placeholder="Precio.. Bs 00.00.-">
			</div>
		</div>
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			<div class="form-group">
				<label for="tiempo_prep">Tiempo Preparación</label>
				<input type="text" name="tiempo_prep" id="tiempo_prep" required value="{{old('tiempo_prep')}}" class="form-control" placeholder="Tiempo Preparación del Producto..">
			</div>
		</div>
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			<div class="form-group">
				<label for="info">Información</label>
				<input type="text" name="info" required value="{{old('info')}}" class="form-control" placeholder="info del Producto..">
			</div>
		</div>
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			<div class="form-group">
