...
@section ('contenido')
	<div class="row">
		...
		{!! Form::open(array('url'=>'delivery/cliente','method'=>'POST','autocomplete'=>'off'))!!}
			{{Form::token()}}
	...
	<div class="row">
		...
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			<div class="form-group">
				...
				<input type="number" name="ci" value="{{old('ci')}}" class="form-control" placeholder="Dirección..">
			</div>	
		</div>
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			<div class="form-group">
		...
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			<div class="form-group">
				...
				<input type="number" name="tel_fijo" value="{{old('tel_fijo')}}" class="form-control" placeholder="Número de documento..">
			</div>
		</div>
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			<div class="form-group">
		...
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			<div class="form-group">
				...
				<input type="text" name="latitud" id="latitud" value="{{old('latitud')}}" class="form-control" placeholder="Latitud..">
			</div>
		</div>
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			<div class="form-group">
				<label for="longitud">Longitud</label>
				<input type="text" name="longitud" id="longitud" value="{{old('longitud')}}" class="form-control" placeholder="Longitud..">
			</div>
		</div>
