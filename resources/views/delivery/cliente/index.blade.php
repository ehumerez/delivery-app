...
@section ('contenido')
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
			<h3>Clientes <a href="cliente/create"><button class="btn btn-success">Nuevo Cliente</button></a></h3><br>
			@include('delivery.cliente.search')
			<br>
		</div>
	</div>
				...
				<table class="table  table-bordered table-condensed table-hover">
					...
					<tr>
						...
						<td>
							...
							<a href="{{URL::action('ClienteController@edit',$cliente->idcliente)}}">
					...
					@include('delivery.cliente.modal')				
					@endforeach
