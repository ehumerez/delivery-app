...
class ProductoCController extends Controller
{
    ...
    public function create() {
        ...
        $productos = DB::table('producto as prod')           
            ...
            ->get();
    	return view('productosc.producto.create',["categorias"=>$categorias,"productos"=>$productos]);
    }
    ...
    public function store(Request $request) {
    	...
    	return Redirect::to('productosc/producto');
    }
    ...
    public function show($id) {
        $producto=DB::table('producto as p')
            ...
            $producto_combos=DB::table('producto_combo as pcc')
                ...
                ->get();
            return view('productosc.producto.show',["producto"=>$producto,"producto_combos"=>$producto_combos]);
    }
