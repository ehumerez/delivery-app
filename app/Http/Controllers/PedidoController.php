...
class PedidoController extends Controller
{
    ...
    public function index(Request $request) {
    	if ($request) {
    		...
    		->paginate(7);
    		return view('delivery.pedido.index',["pedidos"=>$pedidos,"searchText"=>$query]);
    	}
    }
    ...
    public function create() {
        ...
        $productos = DB::table('producto as prod')           
            ...
            ->get();        
    	return view('delivery.pedido.create',["clientes"=>$clientes,"productos"=>$productos,"empleados"=>$empleados,"zonas"=>$zonas]);
    }
    ...
    public function store(Request $request) {
        try {
            ...
            $pedido->ci_empleado = $request->get('ci');
    ...
    public function show($id) {
        ...
        ->get();
        return view('delivery.pedido.show',["pedido"=>$pedido,"cliente"=>$cliente,"empleado"=>$empleado,"zona"=>$zona,"estado_pedido"=>$estado_pedido,"detalle"=>$detalle]);
    }
    ...
    public function edit($id) {
    	...
    	return view('delivery.pedido.edit',["pedido"=>$pedido,"estado_pedidos"=>$estado_pedidos,"cliente"=>$cliente,"zona"=>$zona]);
    }
